...
var resizePizzas = function(size) {
  ...
  // Created a local variable that:
  // 1) replaced document.querySelectorAll() to be the faster
  // document.getElementsByClassName
  // 2) Moved var dx and var newwidth out of the for loop for optimization
...
//I changed document.querySelectorAll('.mover') to document.getElementsByClassName('mover') for optimization.
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //I changed the number from 200 to 35 based on the count of pizzas on the screen.
  for (var i = 0; i < 35; i++) {
